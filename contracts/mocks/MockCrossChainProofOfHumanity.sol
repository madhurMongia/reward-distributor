...
contract MockCrossChainProofOfHumanity is ICrossChainProofOfHumanity {
    ...
    /**
     * @notice Gets the current owner for a humanity ID.
     * @param humanityID The humanity ID to get the owner for.
     * @return The owner address, or zero address if not found or not human.
     */
